...
// 
    ...
    await FileSystem.write({ path: "positive_examples.json", data: generateLinesFor(positiveExamples), })
    await FileSystem.write({ path: "negative_examples.json", data: generateLinesFor(negativeExamples), })
