...
// 
    ...
    FileSystem.write({ path: "positive_examples.json", data: JSON.stringify(positiveExamples,0,1), })
    FileSystem.write({ path: "negative_examples.json", data: JSON.stringify(negativeExamples,0,1), })
